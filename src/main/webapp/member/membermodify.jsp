...
<body>
	...
	<form id="fostyle" method="post" name="modifyform" action="./MemberModifyAction.me">
		...
		<table>
			...
			<tr align="center">
				<td>아이디 :</td>
				<td align="left"><input style="background-color: #E4E4E4;" type="text" name="M_ID" value="<%=member.getM_id()%>" readonly="readonly"></td>
			...
			<tr align="center">
				<td>비밀번호 :</td>
				<td align="left"><input name="M_PW" type="password" value="<%=member.getM_pw()%> " oninput="isSame()"></td>
			</tr>

			<tr align="center">
				<td>비밀번호 확인 :</td>
				<td align="left"><input name="M_PW2" type="password" value="" oninput="isSame()"></td>
			</tr>
			...
			<tr align="center">
				<td>이름 :</td>
				<td align="left"><input style="background-color: #E4E4E4;" type="text" name="M_NAME" value="<%=member.getM_name()%>" readonly="readonly"></td>

			</tr>

			<tr align="center">
				<td>전화번호 :</td>
				<td align="left"><input name="M_TEL" type="text" value="<%=member.getM_tel()%>"></td>
			</tr>

			<tr align="center">
				<td>이메일 주소 :</td>
				<td align="left"><input name="M_EMAIL" type="text" value="<%=member.getM_email()%>"></td>
			</tr>
